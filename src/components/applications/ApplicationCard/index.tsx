...
interface ApplicationCardProps {
  ...
  onStatusUpdate: (applicationId: string, newStatus: string) => Promise<PokemonEncounter | null>;
  onRefresh: () => void;
}
...
export default function ApplicationCard({ application, onStatusUpdate }: ApplicationCardProps) {
  ...
  const handleStatusUpdate = async (newStatus: string) => {
    ...
    console.log('🎯 ApplicationCard: Status update to', newStatus, 'for application', application._id);
